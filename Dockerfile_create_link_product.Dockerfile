...
COPY requirements/requirements.txt /create_link_product/requirements.txt
...
CMD ["dramatiq", "-p 8", "-t 8", "create_link_product_worker", "-Q", "josef_create_link_product_josef"]